				...
				switch ( $arrayelements ) {
					...
					case 17: /* -------------------------------- Category Name -------------------------------------------*/
						...
						<tr>
							...
							<td style='background: #FFF' title='<?php _e( 'Text or HTML to put between categories', 'link-library' ); ?>'>
